...
/***/ function(module, exports, __webpack_require__) {
	...
	var Wall = __webpack_require__(1);
	var Zeus = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Wall.prototype.move = function (canvasWidth, canvasHeight, allWalls) {
	  if (allWalls.length > 0) {
	    ...
	    if (this.orientation === 1) {
	      drawVerticalLine(that, canvasHeight, wallHelper.sortedYValues(allWalls));
	    }
	    if (this.orientation === 0) {
	      drawHorizontalLine(that, canvasWidth, wallHelper.sortedXValues(allWalls));
	    }
	  }
	  return this;
	};
	...
	function findNearestWall(currentWall, canvasSize, wallValues, direction) {
	  var sortedValues = wallValues.sort(function (a, b) {
	    return a - b;
	  });
	...
	var drawVerticalLine = function drawVerticalLine(that, canvasHeight, sortedYValues) {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  xValuesOfWalls: function xValuesOfWalls(walls) {
	    return walls.map(function (wall) {
	      return wall.x, wall.x + 1;
	    });
	  },
	  yValuesOfWalls: function yValuesOfWalls(walls) {
	    return walls.map(function (wall) {
	      return wall.y, wall.y + 1;
	    });
	  },
	  lastWallCreated: function lastWallCreated(walls) {
	    return walls[walls.length - 1];
	  },

	  filteredVertical: function filteredVertical(allWalls) {
	    return allWalls.filter(function (wall) {
	      return wall.orientation === 1;
	    });
	  },

	  filteredHorizontal: function filteredHorizontal(allWalls) {
	    return allWalls.filter(function (wall) {
	      return wall.orientation === 0;
	    });
	  },

	  sortedYValues: function sortedYValues(allWalls) {
	    return _.sortBy(this.filteredHorizontal(allWalls), 'startY').map(function (wall) {
	      return wall.startY;
	    });
	  },

	  sortedXValues: function sortedXValues(allWalls) {
	    return _.sortBy(this.filteredVertical(allWalls), 'startX').map(function (wall) {
	      return wall.startX;
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(6);
	var Ball = __webpack_require__(7);
	...
	Zeus.prototype.existingCanvas = function () {
	  if (this.walls.length > 0) {
	    ...
	    var sortedYValues = _.sortBy(filteredHorizontal, 'startY').map(function (wall) {
	      return wall.startY;
	    });
	    var sortedXValues = _.sortBy(filteredVertical, 'startX').map(function (wall) {
	      return wall.startX;
	    });
	    ...
	    this.walls.forEach(function (wall) {
	      if (wall.building_wall === false) {
	        ...
	        if (wall.orientation === 1) {
	          detectionAroundVerticalWalls(wall, ball, width, height, that);
	        }
	      }
	    });
	  }
	...
	function detectionAroundVerticalWalls(wall, ball, width, height, zeus) {
	  if (wall.x < ball.x) {
	    ...
	    var filteredXValues = _.sortBy(filteredVertical, 'startX').map(function (wall) {
	      return wall.startX;
	    });
	    filteredXValues.push(ball.x);
	    var sortedXValues = filteredXValues.sort(function (a, b) {
	      return a - b;
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BallEdges = __webpack_require__(8);
	var WallHelper = __webpack_require__(2);
	var pry = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"pryjs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	module.exports = {

	  reverseHorizontalVelocityAgainstCanvas: function reverseHorizontalVelocityAgainstCanvas(canvasWidth, ball) {
	  ...
	  checkForValidCollisions: function checkForValidCollisions(walls, ball) {
