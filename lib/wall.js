...
function drawHorizontalLine(that, canvasWidth, sortedXValues) {
  ...
  lineDrawer(drawLeft, drawRight, that);
}

function lineDrawer(drawLeft, drawRight, that) {
...
function findNearestWallToLeft(currentWall, canvasWidth, wallXValues) {
  wallXValues.push(currentWall);
  var sortedXValues = wallXValues.sort(function(a,b){return a - b; });
...
function findNearestWallToRight(currentWall, canvasWidth, wallYValues) {
  var sortedYValues = wallYValues.sort(function(a,b){return a - b ;});
