...
Wall.prototype.move = function (canvasWidth, canvasHeight, allWalls) {
  if (allWalls.length > 0) {
    var filteredHorizontal = allWalls.filter(function(wall){return wall.orientation === 0;});
    var filteredVertical = allWalls.filter(function(wall){return wall.orientation === 1;});
