...
// var cookieDisplay = document.cookie.split(';')[1].split('=')[1];
// $('#high_score').text(cookieDisplay);
// var cookieDisplay = document.cookie.split(';')[1].split('=')[1] || 0;
// if(this.level > parseInt(cookieDisplay)){document.cookie = "high_score="+this.level;}
